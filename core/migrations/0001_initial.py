# Generated by Django 3.2.12 on 2022-02-13 02:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(choices=[('lni-cog', 'Cog'), ('lni-stats-up', 'Stats Up'), ('lni-users', 'Users'), ('lni-layers', 'Layers'), ('lni-mobile', 'Mobile'), ('lni-rocket', 'Rocket')], max_length=12, verbose_name='Icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fabebook', models.CharField(default='#', max_length=100, verbose_name='Facebook')),
